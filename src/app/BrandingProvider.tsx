...
/**
 * This is basically the theme from Material UI docs.
 * All I did was tweaking it for my own preferences.
 *
 *
 */
      ...
      MuiChip: {
        styleOverrides: {
          ...
          deleteIcon: {
            ...
            "&:hover": {
              color:
                theme.palette.mode === "dark" ? theme.palette.grey[100] : theme.palette.primary[900]
            }
          }
        }
      },
